...
import kr.ac.hanyang.tosca2camp.rest.resources.InterfaceResource;
...
public class InterfaceApi {
    ...
    @GET
    @Path("interface")    
    public InterfaceTypeModel getInterfaceDefintion(@QueryParam(value = "type") String type){
    	return InterfaceResource.getInterfaceTypeDefinition(type); 
    }
