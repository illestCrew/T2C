...
import kr.ac.hanyang.tosca2camp.rest.resources.GroupTypeResource;
...
public class GroupApi {
    ...
    @GET
    @Path("group")    
    public GroupTypeModel getGroupType(@QueryParam(value = "type") String type){
    	return GroupTypeResource.getGroupType(type); 
    }
