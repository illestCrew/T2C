 ...
 * </p>
 * <ul>
 *   <li>{@link kr.ac.hanyang.tosca2camp.rest.model.impl.StringArrayImpl#getEntry <em>Entry</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringArrayImpl extends MinimalEObjectImpl.Container implements Array {
	/**
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.STRING_ARRAY;
	}
	...
	public void setEntry(String newEntry) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.STRING_ARRAY__ENTRY, oldEntry, entry));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.STRING_ARRAY__ENTRY:
				return getEntry();
		}
