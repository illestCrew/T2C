...
public class GroupTypeModelImpl extends MinimalEObjectImpl.Container implements GroupTypeModel, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4880334742981921601L;
	...
	public EList<PropertyModel> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<PropertyModel>(PropertyModel.class, this, ModelPackage.GROUP_TYPE_MODEL__PROPERTIES);
		}
		return properties;
	}
	...
	public EList<InterfaceTypeModel> getInterfaces() {
		if (interfaces == null) {
			interfaces = new EObjectContainmentEList<InterfaceTypeModel>(InterfaceTypeModel.class, this, ModelPackage.GROUP_TYPE_MODEL__INTERFACES);
		}
		return interfaces;
	}
